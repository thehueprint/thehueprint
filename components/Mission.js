export default function Mission() {
  return (
    <section className="relative flex h-80 flex-col justify-center bg-[#4649C3] lg:block lg:h-[34.3125rem] lg:bg-[#EFEFEF]">
      ...
      <div className="relative h-56 w-full border-y-8 border-l-8 border-solid border-black lg:absolute lg:top-[4.1875rem] lg:right-0 lg:z-10 lg:flex lg:h-[26.3125rem] lg:w-[63.5625rem] lg:justify-end lg:border-y-[15px] lg:border-l-[15px] lg:border-[#FD0505]">
        {/*text inside*/}
